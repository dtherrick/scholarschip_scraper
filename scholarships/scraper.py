                    ...
                    if i == 0:
                        ...
                        for j in range(len(cell_data)):
                            if j == 0:
                                ...
                                row_data["scholarshipDetailURL"] = (
                                    f"https://www.careeronestop.org/toolkit/training/find-scholarships-detail.aspx?scholarshipId={scholarshipID}"
                                )
...
params = {
    "keyword": "architecture engineering construction",
    "curPage": "2",
    "pagesize": "500",
    "studyLevelFilter": "Bachelor's Degree",
}  # Add your parameters
...
data_dir = Path(f"~/Data/scholarships/scraped_data{params['curPage']}.csv").expanduser()
scraper.save_to_csv(data_dir.as_posix())  # Adjust the path as needed
